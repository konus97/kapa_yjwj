			...
			<div class="wrap">
				...
				<div class="cs_wrap cs_wrap--agenda_view">
					...
					<c:forEach var="formatter" items="${formatterList}" varStatus="status">
						<input type="text" value="${formatter.decisionId }">
						<!-- 목차 시작 -->
						...
						<div class="cs_body">
							...
							<c:forEach var="typeList" items="${typeList}" varStatus="status">
								<c:if test="${formatter.decisionId eq typeList.decisionId}">
							<div class="cs_title">
							...
							<c:forEach var="deliberateOpinionDTO" items="${formatter.deliberateOpinionDTOS}" varStatus="status">
								<c:if test="${typeList.decisionId eq deliberateOpinionDTO.decisionId}">
							<c:if test="${typeList.opinionType eq deliberateOpinionDTO.type}">
