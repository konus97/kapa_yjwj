                        ...
                        <div class="cs_body">
                                          ...
                                          <div class="f_field">
                                                ...
                                                <div class="ff_wrap ff_wrap_inner ff_wrap_inner02">
                                                    ...
                                                    <div style="width: 100%" id="fileList2">
                                                        <div id="fileInfo2-1" class="input-wrap wid100 fileInfo2" >
                                                            <div class="input40" style="cursor: pointer;" onclick="triggerFileUpload('2','1');return false;" >
	                                                             	파일 없음
	                                              			 </div>
                                                            <button class="btn nohover t4 small"   onclick="removeTarget('2','1');return false;">
                                                                <i class="close icon white"></i>
                                                               			 삭제
                                                            </button>
                                                            <button class="btn nohover t4 small"  onclick="addNewTarget('2');return false;" >
                                                                <i class="pluse icon white"></i>
                                                                	추가
                                                            </button>
                                                        </div>
                                                ...
                                                <div class="ff_wrap ff_wrap_inner ff_wrap_inner02" >
                                                    ...
                                                    <div style="width: 100%" id="fileList3">
                                                        ...
                                                        <div id="fileInfo3-1" class="input-wrap wid100 fileInfo3" >
                                                            <div class="input40" style="cursor: pointer;" onclick="triggerFileUpload('3','1');return false;" >
	                                                             	파일 없음
	                                              			 </div>
                                                            <button class="btn nohover t4 small"  onclick="removeTarget('3','1');return false;">
                                                                <i class="close icon white"></i>
                                                               			 삭제
                                                            </button>
                                                            <button  class="btn nohover t4 small" onclick="addNewTarget('3');return false;" >
                                                                <i  class="pluse icon white"></i>
                                                                	추가
                                                            </button>
                                                        </div>
                                                ...
                                                <div class="ff_wrap ff_wrap_inner ff_wrap_inner02" >
                                                    ...
                                                    <div style="width: 100%" id="fileList4">
                                                         <div id="fileInfo4-1" class="input-wrap wid100 fileInfo4" >
                                                            <div class="input40" style="cursor: pointer;" onclick="triggerFileUpload('4','1');return false;" >
	                                                             	파일 없음
	                                              			 </div>
                                                            <button class="btn nohover t4 small" onclick="removeTarget('4','1');return false;">
                                                                <i class="close icon white"></i>
                                                               			 삭제
                                                            </button>
                                                            
                                                            <button  class="btn nohover t4 small" onclick="addNewTarget('4');return false;" >
                                                                <i  class="pluse icon white"></i>
                                                                	추가
                                                            </button>
                                                        </div>
                                ...
                                <div class="mt40 btn_wrap">
                                    <ul class="btns">
                                        ...
                                        <li>
                                            <a href="#" class="btn t1 h50 big" onclick="goToCityAnnouncementList();return false">목록</a>
                                        </li>
                                    </ul>
                                </div>
