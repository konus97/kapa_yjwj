            ...
            <div id="contents" class="c_main">
                <div class="wrap center">
                                ...
                                <div class="cms_list">
                                    <ul>
                                        <li>
                                            <a
                                                href="#"
                                                onclick="readyAlert();return false;"
                                                >관련자료 업로드</a
                                            >
                                        </li>
                                        <li>
                                            <a href="${pageContext.request.contextPath}/implementer/application.do">나의 재결신청현황</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="cms_wrap">
                                ...
                                <div class="cms_list">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="${pageContext.request.contextPath}/cities/announcement.do">나의 열람공고현황</a>                                      
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="cms_box t3">
                            ...
                            <div class="cms_wrap">
                                ...
                                <div class="cms_list">
                                    <ul>
                                        <li>
                                        	<a href="${pageContext.request.contextPath}/appraiser/agenda.do">나의 심의 안건정보</a>                                                          
                                        </li>
                                        <li>
                                            <a href="${pageContext.request.contextPath}/appraiser/application.do">나의 심의 안건정보</a>                                        
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="cms_box t4">
                            ...
                            <div class="cms_wrap">
                                ...
                                <div class="cms_list">
                                    <ul>
                                        <li>
                                       	   <a href="${pageContext.request.contextPath}/decision/agenda.do">나의 심의 안건정보</a>                                                         
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="cms_box t5">
                            ...
                            <div class="cms_wrap">
                                ...
                                <div class="cms_list">
                                    <ul>
                                        <li>
                                        	<a href="${pageContext.request.contextPath}/deliberate/agenda.do">나의 심의 안건정보</a>                                                   
                                        </li>
                                    </ul>
                                </div>
                                <div class="cms_latest">
                    ...
                    <div class="cm_wrap">
                        <div class="cm_quick">
                            <div class="cmq_title">
                                <h3><mark>빠른</mark> 서비스</h3>
                                <p>필요한 서비스를 빠르게 이동하세요!</p>
                            </div>
                            <div class="cmq_wrap">
                                <ul>
                                    <li>
                                    ...
                                    <li>
                                        <a
                                            href="#"
                                            onclick="readyAlert();return false;"
                                            ><i class="cmq_icon t6"></i
                                            ><span>열람공고</span></a
                                        >
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/land/committee.do"
                                            ><i class="cmq_icon t3"></i
                                            ><span>서울특별시</span>
                                            <span>지방토지수용위원회</span>
                                            <span>위원명단</span></a
                                        >
