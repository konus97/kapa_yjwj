						...
						<div class="cms_wrap">
							<div class="cms_form">
								<form id="cms_form1" name="cms_form1">
									<fieldset>
										<legend>검색폼</legend>
										<input type="text" id="cmsf1_input" name="cmsf1_input"
											class="s_input" placeholder="사건번호 혹은 사업명 입력" />
						...
						<div class="cms_wrap">
							<div class="cms_form">
								<form id="cms_form2" name="cms_form2">
									<fieldset>
										<legend>검색폼</legend>
										<input type="text" id="cmsf2_input" name="cmsf2_input"
						...
						<div class="cms_wrap">
							<div class="cms_form">
								<form id="cms_form3" name="cms_form3">
									<fieldset>
										<legend>검색폼</legend>
										<input type="text" id="cmsf3_input" name="cmsf3_input"
											placeholder="사건번호 혹은 사업명 입력" />
										<button type="submit" class="cpf_btn">
											<span class="blind">검색</span>
										</button>
					...
					<div class="cms_box t4">
						...
						<div class="cms_wrap">
							...
							<div class="cms_list">
								<ul>
									<li><a
										href="${pageContext.request.contextPath}/decision/agenda.do">나의
											심의 안건정보</a></li>
								</ul>
							</div>
							<div class="cms_latest">
								<ul>
									<li><a href="#" onclick="readyAlert();return false;">12월
											2일 (5건)</a></li>
									<li><a href="#" onclick="readyAlert();return false;">12월
											23일 (6건)</a></li>
								</ul>
					...
					<div class="cms_box t5">
						...
						<div class="cms_wrap">
							...
							<div class="cms_list">
								<ul>
									<li><a
										href="${pageContext.request.contextPath}/deliberate/agenda.do">나의
											심의 안건정보</a></li>
								</ul>
							</div>
							<div class="cms_latest">
								<ul>
									...
									<li><a href="#" onclick="readyAlert();return false;">12월
											23일 (6건)</a></li>
									<li><a href="#" onclick="readyAlert();return false;">1월
											4일 (3건)</a></li>
									<li><a href="#" onclick="readyAlert();return false;">1월
											25일 (7건)</a></li>
								</ul>
				...
				<div class="cm_wrap">
					<div class="cm_quick">
						<div class="cmq_title">
							...
							<p>
								필요한 서비스로<br>빠르게 이동하세요!
							</p>
						</div>
						<div class="cmq_wrap">
							<ul>
								<li><a href="#" onclick="readyAlert();return false;"><i
										class="cmq_icon t1"></i><span>재결사건 검색</span></a></li>
								<li><a href="#" onclick="readyAlert();return false;"><i
										class="cmq_icon t2"></i><span>재결관련</span> <span>서류 업로드</span></a>
								</li>
								<li><a href="#" onclick="readyAlert();return false;"><i
										class="cmq_icon t6"></i><span>열람공고</span></a></li>
								<li><a
									href="${pageContext.request.contextPath}/land/committee.do"><i
										class="cmq_icon t3"></i><span>서울특별시</span> <span>지방토지수용위원회</span>
										<span>위원명단</span></a></li>
							</ul>
						</div>
					</div>
					<div class="cm_verdict">
						<div class="cmv_list t1">
							...
							<ul>
								<li><span>금일</span> <span><mark>0</mark></span></li>
								<li><span>금년</span> <span><mark>0</mark></span></li>
							</ul>
						</div>
					</div>
				</div>
