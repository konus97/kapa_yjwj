...
<html lang="ko">
    ...
    <body>
            ...
            <div id="contents" class="c_sub">
                <div class="wrap">
                    <div class="sub_title sub_title05">
                        <h2 class="title bold center">심의서 작성</h2>
                    </div>
                    ...
                    <div class="cs_wrap">
                        <div class="cs_head">
                            <h3 class="title bold cb">심의서 작성</h3>
                        </div>
                        <div class="cs_body">
                            <div class="cs_search">
        ...
        <script src="../js/decision/content.js"></script>
   		<script src="../js/decision/register/list/block.js"></script>
        <script src="../js/decision/register/list/list.js"></script>
        
  		<script type="text/javascript">
     
		    $(document).ready(function () {
		    	
		    	getAgendaRegisterList(1);
