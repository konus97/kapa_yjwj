...
<html lang="ko">
    ...
    <body>
            ...
            <div id="contents" class="c_sub">
                <div class="wrap">
                    <div class="sub_title sub_title02">
                        <h2 class="title bold center">재결의견작성</h2>
                    </div>
                    ...
                    <div class="cs_wrap">
                        <div class="cs_head">
                            <h3 class="title bold cb">재결의견 조회</h3>
                        </div>
                        <div class="cs_search">
        ...
        <script src="../js/implementer/opinion/block.js"></script>
        <script src="../js/implementer/opinion/list.js"></script>
