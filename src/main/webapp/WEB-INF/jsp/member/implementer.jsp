...
<html lang="ko">
    ...
    <body>
                    ...
                    <form class="form" method="POST" id="registerForm">
                        <fieldset>
                           ...
                           <!--<div class="input-wrap">
							...
							<!-- 팝업, 약관 아직...
					        <section class="modalTermsCheckbox">
							    <div class="Terms_box">
							        <div class="Terms_head">
							            <h3 class="p_title">이용약관</h3>
							            <span onClick="termsCheckboxClose();">닫기</span>
							        </div>
							    </div>
							</section> -->
        ...
        <!-- 팝업, 약관 -->
        <div class="popup modalTermsCheckbox">
		    <div class="p_box">
		        <div class="p_head">
		            <h3 class="p_title">이용약관</h3>
                        ...
                        <fieldset>
                            ...
                            <div class="form find">
                                ...
                                <div class="f_btn btn_wrap mt30">
                                    <button class="btn" onsubmit="return false">
                                       	 확인
                                    </button>
                                    <!-- 확인 버튼 클릭 시 
